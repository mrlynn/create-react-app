This project was bootstrapped with [Create STAR App](https://github.com/mrlynn/create-star-app) which was forked from [Create React App](https://github.com/facebook/create-react-app).
